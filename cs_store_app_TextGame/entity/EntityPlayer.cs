...
namespace cs_store_app_TextGame
{
    public class EntityPlayer : Entity
    {
        ...
        public override Handler DoMoveBasic(TranslatedInput input)
        {
            ...
            return Handler.HANDLED(MESSAGE_ENUM.BASE_STRING, CurrentRoomDisplayParagraph);
        }
        ...
        {
            // "look"
            if (input == null || input.Words.Length < 2) { return Handler.HANDLED(MESSAGE_ENUM.BASE_STRING, CurrentRoomDisplayParagraph); }
            // look <item|npc>
        ...
        public override Handler DoLook(string strWord)
        {
            ...
            if (npc != null) { return Handler.HANDLED(MESSAGE_ENUM.BASE_STRING, npc.DisplayParagraph); }
        ...
        public override Handler DoLook(string strWord1, string strWord2, string strWord3)
        {
            ...
            if (strWord1 == "in")
            {
                ...
                else if(strWord2 == "my")
                {
                    ...
                    if (Backpack != null)
                    {
                        return Handler.HANDLED(MESSAGE_ENUM.BASE_STRING, Backpack.ItemsParagraph);
                    }
        ...
        public override Handler DoLookHands(TranslatedInput input)
        {
            ...
            return Handler.HANDLED(MESSAGE_ENUM.BASE_STRING, HandsParagraph);
        }
        ...
        public override Handler DoEat(TranslatedInput input)
        {
            ...
            if (itemToEat == null) { return Handler.HANDLED(MESSAGE_ENUM.ERROR_BAD_INPUT); }
            ...
            return Handler.HANDLED(message, itemToEat.NameAsParagraph, itemToEat.HealthPerBite.ToString().ToParagraph(), itemToEat.NumberOfBites.ToString().ToParagraph());
        }
        public override Handler DoDrink(TranslatedInput input)
        {
            ...
            if (itemToDrink == null) { return Handler.HANDLED(MESSAGE_ENUM.ERROR_BAD_INPUT); }
            ...
            return Handler.HANDLED(message, itemToDrink.NameAsParagraph, itemToDrink.MagicPerDrink.ToString().ToParagraph(), itemToDrink.NumberOfDrinks.ToString().ToParagraph());
        }
        ...
        public override Handler DoEquip(TranslatedInput input)
        {
            ...
            if (itemToEquip == null) { return Handler.HANDLED(MESSAGE_ENUM.ERROR_BAD_INPUT); }
            ...
            switch (itemToEquip.Type)
            {
                case ITEM_TYPE.ARMOR_CHEST:
                    if (ArmorChest != null) { return Handler.HANDLED(MESSAGE_ENUM.ERROR_ALREADY_EQUIPPED); }
                ...
                case ITEM_TYPE.ARMOR_FEET:
                    if (ArmorFeet != null) { return Handler.HANDLED(MESSAGE_ENUM.ERROR_ALREADY_EQUIPPED); }
                ...
                case ITEM_TYPE.ARMOR_HEAD:
                    if (ArmorHead != null) { return Handler.HANDLED(MESSAGE_ENUM.ERROR_ALREADY_EQUIPPED); }
                ...
                case ITEM_TYPE.CONTAINER:
                    if (Backpack != null) { return Handler.HANDLED(MESSAGE_ENUM.ERROR_ALREADY_EQUIPPED); }
                    message = MESSAGE_ENUM.PLAYER_EQUIP_BACKPACK;
                    Backpack = itemToEquip as ItemContainer;
                    break;
                case ITEM_TYPE.ACCESSORY_AMULET:
                    if (Amulet != null) { return Handler.HANDLED(MESSAGE_ENUM.ERROR_ALREADY_EQUIPPED); }
                    message = MESSAGE_ENUM.PLAYER_EQUIP_ACCESSORY_AMULET;
                    Amulet = itemToEquip as ItemAccessoryAmulet;
                    break;
                case ITEM_TYPE.ACCESSORY_RING:
                    if (Ring1 != null && Ring2 != null) { return Handler.HANDLED(MESSAGE_ENUM.ERROR_ALREADY_EQUIPPED); }
            ...
            return Handler.HANDLED(message, itemToEquip.NameAsParagraph);
        }
        public override Handler DoRemove(TranslatedInput input)
        {
            ...
            Handler handler = Handler.HANDLED(MESSAGE_ENUM.ERROR_BAD_INPUT);
        ...
        public override Handler DoPrice(TranslatedInput input)
        {
            ...
            if (handler.Equals(Handler.HANDLED(MESSAGE_ENUM.ERROR_BAD_ITEM)))
            {
                item = LeftHand;
        ...
        public override Handler DoAttack(TranslatedInput input)
        {
            ...
            {
                return Handler.HANDLED(MESSAGE_ENUM.ERROR_PLAYER_ATTACKS_BAD_WEAPON, RightHand.NameAsParagraph);
            }
        ...
        {
            if (input.Words.Length > 1) { return Handler.HANDLED(MESSAGE_ENUM.ERROR_BAD_INPUT);}
            return Handler.HANDLED(MESSAGE_ENUM.PLAYER_SHOW_HEALTH, HealthString.ToParagraph(), MagicString.ToParagraph());
        }
