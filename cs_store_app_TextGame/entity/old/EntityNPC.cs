...
//            get
//            {
//                return base.Name + " (" + NID.ToString() + ") (" + CurrentHealth.ToString() + ":" + MaximumHealth.ToString() + ") (" + Faction.ToString() + ")";
//            }
//            set
//            {
//                base.Name = value;
...
//            ID = template.ID;
//            Faction = template.RelationshipGroup;
//            Name = template.Name;
//            Gold = template.Gold;
...
//                    Amulet = RightHand as ItemArmorNeck;
//                    break;
//                case ITEM_TYPE.ARMOR_FINGER:
//                    if (Ring1 == null) { Ring1 = RightHand as ItemArmorFinger; }
//                    else if (Ring2 == null) { Ring2 = RightHand as ItemArmorFinger; }
...
//                case ITEM_TYPE.ARMOR_NECK:
//                    if (Amulet != null) { return Handler.UNHANDLED(); }
//                    Amulet = LeftHand as ItemArmorNeck;
//                    break;
//                case ITEM_TYPE.ARMOR_FINGER:
//                    if (Ring1 == null) { Ring1 = LeftHand as ItemArmorFinger; }
//                    else if (Ring2 == null) { Ring2 = LeftHand as ItemArmorFinger; }
//                    else { return Handler.UNHANDLED(); }
//                    break;
//                case ITEM_TYPE.ARMOR_CHEST:
//                    if (ArmorChest != null) { return Handler.UNHANDLED(); }
